...
Реализация кастомной админ-панели, ориентированной на управление через текстовые команды. Проект написан на языке **Luau** в **Roblox Studio** с упором на сетевую безопасность и защиту от читеров.

## 🚀 Функционал и возможности
* **Базовые команды:** Из начальных команд доступны `speed`, `jump`, `kill`, `heal`, `kick`.
